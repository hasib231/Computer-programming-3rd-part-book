...
int main()
{
    ...
    int max_item=extract_max(heap,heap_size);
    printf("max item = %d",max_item);

    int heap2_size=insert_node(heap,heap_size-1,20);
    printf("\nAfter insert\n");
    print_heap(heap,heap2_size);

    heap1=is_max_heap(heap,heap2_size);
    if(heap1==1)
    {
